...
5. **Voice Forge** registers custom voices using Coqui TTS embeddings; synthesizes narration from scripts while tracking render counts and last-use timestamps.
